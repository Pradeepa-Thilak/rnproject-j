        ...
        <View style={styles.ordercon}>
            ...
            <View style={styles.osdeets}>
                ...
                <View style={styles.osdeetsitem}>
                    ...
                    <Text style={styles.righttxt}>₹{Number(totalValue.orderValue).toLocaleString('en-IN', { minimumFractionDigits:2, maximumFractionDigits: 2})}</Text>
                </View>
                <View style={styles.osdeetsitem}>
                    <Text style={styles.lefttxt}>Product Discount</Text>
                    <Text style={styles.righttxt}>₹{Number(totalValue.discountValue).toLocaleString('en-IN', { minimumFractionDigits:2, maximumFractionDigits: 2})}</Text>
                ...
                <View style={styles.osdeetsitem}>
                  ...
                  <View style={styles.total}>
                    ...
                    <Text style={styles.righttxt}>₹{Number(totalValue.grandTotal).toLocaleString('en-IN', { minimumFractionDigits:2, maximumFractionDigits: 2})}</Text>

                </View>
                <View style={styles.bottomline}>
                    <Text  style={styles.bottomline}>Order savings </Text>
                    <Text  style={styles.bottomline}>₹{Number(totalValue.orderSaving).toLocaleString('en-IN', { minimumFractionDigits:2, maximumFractionDigits: 2})}</Text>
            ...
            <View style={styles.bottomdeets}>
                <View style={[{borderRightWidth:1,borderRightColor:"#ccc"},styles.bottomdeetsitem]}>
              ...
              <Text  style={styles.bottomdeetsitemtxt}>Safe and secure transaction</Text>

                </View>

               <View style={[{borderLeftWidth:1,borderLeftColor:"#ccc"},styles.bottomdeetsitem]}>
                   <View style={{marginBottom:10}}>
