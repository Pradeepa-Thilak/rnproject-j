...
const cart = createSlice({
    ...
    reducers: {
        addToCart:(state,action) => {
            ...
            const defaultSize = action.payload._source.Sizes.find(size => size.IsDefault===1 )
...
export const { addToCart, removeFromCart, increaseQty, decreaseQty, clearCart,updateSize, updateQty } = cart.actions;
