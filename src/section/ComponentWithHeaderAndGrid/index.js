...
import { styles } from '../../screens/coastal/costal_styles';
...
const ComponentWithHeaderAndGrid = ({ details }) => {
  ...
  return (
      ...
      <Text style={[styles.componentTxt, { marginBottom: 20 }]}>{textData?.a_title}</Text>
      <Text style={styles.bestSellerTxt}>{getDecodeText(textData?.a_description)}</Text>
