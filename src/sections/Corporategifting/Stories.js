    ...
    return(
        <View style={styles.maincon}>
            <View style={styles.top}>
                <Image
                source={{uri:"https://imagescdn.jaypore.com/uploads/micrositmedia/production/elephant_4320_1721046054344_3771_1730194773642.png"}}
                style={{width:"100%",
                    aspectRatio:1080/121,
                    marginVertical:20
                }}
                />
                <Text style={styles.toptxt}>Stories of Delight: Our Clients' Perspective</Text>
                <Text style={styles.para}>
                    Hear the stories of delight, joy & satisfaction as our patrons share their journey with Jaypore. Join our community of satisfied customers & walk through a world of curated elegance & exquisite craftsmanship. Experience Jaypore's legacy through the eyes of those who have made it a part of their story.
                </Text>
