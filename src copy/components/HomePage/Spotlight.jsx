...
const Spotlight = ({ details }) => {
  ...
  return (
    <View style={styles.con}>
      <Text style={styles.topheadtxt}>Brands</Text>
      <View style={styles.bothead}>
        <Text style={styles.botheadtxt}>Brand</Text>
        <Image
          source={{
            uri: 'https://imagescdn.jaypore.com/img/app//brands/jaypore/home/desktop/spotlightPrev.png',
          }}
          style={styles.botheadimgstyle}
        />

        <Text style={[styles.botheadtxt, styles.botheadtxtspotlight]}>
          Spotlight
        </Text>
        <Image
          source={{
            uri: 'https://imagescdn.jaypore.com/img/app//brands/jaypore/home/desktop/spotlightNext.png',
          }}
          style={styles.botheadimgstyle}
        />
      </View>
...
const styles = StyleSheet.create({
  ...
  botheadtxtspotlight: { color: colors.brownColor1 },
  botheadimgstyle: {
    width: 30,
    height: 30,
  },
