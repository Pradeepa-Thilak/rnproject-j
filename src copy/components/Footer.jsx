...
import { footBadges, footValues } from '../lib/ConstData';
...
const Footer = () => {
  ...
  const renderFooterIcon = (item, index) => (
    <View
      style={[
        styles.badge,
        index === footBadges.length - 1 && styles.lastBadge,
      ]}
    >
  ...
  const renderFooterMenu = (item) => (
    <View>
      <Pressable
        style={[
          styles.footdrop,
          dropMenu === item.name ? styles.noMargin : styles.smallMargin,
        ]}
      ...
      <View style={styles.introContainer}>
        <View style={styles.intro}>
          ...
          <Text style={styles.introText1}>
            {
              "Jaypore: Discover India's Most Beautiful Products and Their Unique Stories"
            }
          </Text>
        </View>
...
const styles = StyleSheet.create({
  ...
  badge: {
    ...
    borderColor: colors.greenColor1,
  },
  footer: {
    paddingVertical: 40,
  ...
  mail: {
    ...
    textShadowcolor: colors.blackColor1,
