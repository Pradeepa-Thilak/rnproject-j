...
export default function AnjuModiCollection({ details, buttonText, seq4AR }) {
    ...
    <View>
      ...
      {buttonText && (
        <Pressable style={styles.apiButton}>
          <Text style={styles.apiButtonText}>{buttonText}</Text>
        </Pressable>
      )}
      ...
      {seq4 && (
        <Image
          ...
          style={[
            styles.fullImage,
            seq4AR ? { aspectRatio: 355 / 43 } : { aspectRatio: 724 / 237 },
          ]}
        />
      )}
    </View>
