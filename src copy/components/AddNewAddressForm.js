  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView style={styles.scrollcontainer}>
        <View
          style={[styles.PincodeInputBox_container, styles.pincodeOverride]}
        >
          <Text
            pointerEvents="none"
            style={[
        ...
        <View>
          ...
          <View style={styles.InputContainer}>
            ...
            <TextInput
              style={[styles.InputBox, styles.inputHighlight]}
          ...
          <View style={styles.flex}>
            <Pressable
              style={[
                ...
                saveAddress === 'Home' && styles.selectedBtn,
              ]}
              onPress={() => setSaveAddress('Home')}
            >
              <Text
                style={[
                  styles.SaveAddressBtnText,
                  saveAddress === 'Home' && styles.selectedBtnText,
                ]}
              >
                Home
              </Text>
            ...
            <Pressable
              style={[
                styles.SaveAddressBtn,
                saveAddress === 'Office' && styles.selectedBtn,
              ]}
            ...
            >
              <Text
                style={[
                  styles.SaveAddressBtnText,
                  saveAddress === 'Office' && styles.selectedBtnText,
                ]}
              >
                Office
              </Text>
            ...
            <Pressable
              style={[
                styles.SaveAddressBtn,
                saveAddress === 'Others' && styles.selectedBtn,
              ]}
            ...
            >
              <Text
                style={[
                  styles.SaveAddressBtnText,
                  saveAddress === 'Others' && styles.selectedBtnText,
                ]}
              >
                Others
              </Text>
          ...
          {saveAddress === 'Others' && (
            <View style={styles.InputContainer}>
              <Text
                style={[
                  styles.InputLabel,
                  (focused === 'saveAdd' || form.saveAdd.length > 0) &&
                    styles.InputLabelActive,
                ]}
              >
                Save Address*
      ...
      <View>
        <View style={styles.AddressBottomContain}>
          <Pressable
            style={[styles.AddressSaveBtn, disabled && styles.disabledBtn]}
            disabled={disabled}
          >
