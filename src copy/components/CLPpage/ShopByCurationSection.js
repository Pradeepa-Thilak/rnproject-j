...
const ShopByCurationSection = () => {
  return (
    <View>
      ...
      <ImageComponents uri={ShopByCurationImg[0].uri} height={width * 0.11} />
      {/* ✅ Brand Image — ImageComponents */}
      <ImageComponents uri={ShopByCurationImg[1].uri} height={width * 0.31} />
      ...
      <ImageComponents uri={ShopByBrandBottomImg.uri} height={width * 0.09} />
    </View>
  );
};
