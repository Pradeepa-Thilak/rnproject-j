...
import WebCart from '../screens/WebCart';
      ...
      >
        ...
        <Stack.Screen
          ...
          options={{
            headerTitle: () => (
              <View>
                <Text style={[styles.cartTxt, styles.cartText]}>
                  Shopping Bag{' '}
            ...
            headerRight: () => (
              <View style={styles.cartHead}>
                ...
                <Text style={[styles.cartTxt, styles.HeaderRight]}>of 2</Text>
              </View>
            ),
          }}
        />
        ...
        <Stack.Screen
          name={'houseoffashionjewelry'}
          component={houseoffashionjewelry}
        />
        <Stack.Screen name={'EOSS'} component={EossScreen} />
        <Stack.Screen
          name={'theanjumodicollection'}
          component={theanjumodicollection}
        />
        ...
        <Stack.Screen name="WebViewCart" component={WebCart} />
      </Stack.Navigator>
      <AuthModal
