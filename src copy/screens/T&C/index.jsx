    ...
    <ScrollView>
      <View style={styles.TandC_Container}>
        ...
        <Text style={styles.TandC_Content}>
          Welcome to JAYPORE. This page lists current Offers and other related
          details. Please read the terms and conditions carefully before
          participating in an Offer. By participating in an Offer, you agree
        ...
        <View>
          <Text style={styles.TandC_Content}>Terms & Conditions</Text>
        </View>
        <View>
          {terms.map((item, ind) => (
            <View style={styles.TandC_TermContainer} key={ind}>
              <Text style={styles.Text}>{'\u2022'}</Text>
              <Text style={[styles.TandC_Content, styles.TandC_TermTxt]}>
                {item}
              </Text>
            </View>
          ))}
