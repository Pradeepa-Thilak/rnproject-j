...
import { removeFromWishlist, updateWishlistSize } from '../slice/wishListSlice';
              ...
              <View style={styles.dropDownMenuContainer}>
                {product.Sizes.map((size, ind) => (
                  <Pressable
                    ...
                    onPress={() => {
                      dispatch(
                        updateWishlistSize({ id: item._id, size: size.Name }),
                      );
                      setSize(null);
                    }}
                    style={[
